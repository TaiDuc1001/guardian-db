...
INSERT INTO Order_ (OrderID, UserID, TotalPrice, DateOrdered, DeliveryAddressID, VoucherID, ShippingFee, ShippingVATAmount, DiscountedAmount, FinalAmount, FinalVATAmount, FinalAmountIncludeVAT) VALUES
    ('O001', 'U001', 150000, '2024-10-01', 'A001', 'V001', 20000, 2000, 5000, 145000, 14000, 159000),
    ('O002', 'U002', 300000, '2024-10-05', 'A002', 'V002', 20000, 2000, 10000, 290000, 28000, 318000),
    ('O003', 'U003', 250000, '2024-10-10', 'A003', 'V003', 20000, 2000, 7500, 242500, 24000, 266500),
    ('O004', 'U001', 500000, '2024-10-15', 'A004', 'V001', 20000, 2000, 15000, 485000, 48000, 533000),
    ('O005', 'U002', 450000, '2024-10-20', 'A005', 'V004', 20000, 2000, 12000, 438000, 43000, 483000),
    ('O006', 'U003', 320000, '2024-10-25', 'A006', 'V005', 20000, 2000, 8000, 312000, 30000, 342000),
    ('O007', 'U004', 220000, '2024-10-30', 'A007', 'V002', 20000, 2000, 5000, 215000, 21000, 236000),
    ('O008', 'U005', 600000, '2024-11-01', 'A007', 'V003', 20000, 2000, 18000, 582000, 57000, 639000),
    ('O009', 'U005', 380000, '2024-11-05', 'A007', 'V004', 20000, 2000, 9000, 371000, 36000, 407000),
    ('O010', 'U004', 550000, '2024-11-10', 'A007', 'V005', 20000, 2000, 16000, 534000, 52000, 586000);
...
INSERT INTO ProductOrder (OrderID, ProductID, Quantity, Amount, VATAmount, AmountIncludeVAT) VALUES
    ('O001', 'P001', 2, 300000, 30000, 330000),
    ('O002', 'P002', 1, 150000, 15000, 165000),
    ('O003', 'P003', 3, 450000, 45000, 495000),
    ('O004', 'P004', 1, 120000, 12000, 132000),
    ('O005', 'P005', 2, 250000, 25000, 275000),
    ('O006', 'P006', 1, 200000, 20000, 220000),
    ('O007', 'P007', 4, 80000, 8000, 88000),
    ('O008', 'P008', 3, 330000, 33000, 363000),
    ('O009', 'P007', 2, 270000, 27000, 297000),
    ('O010', 'P008', 1, 500000, 50000, 550000);
