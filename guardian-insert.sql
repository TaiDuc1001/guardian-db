...
VALUES 
    ...
    ('P001', N'Sữa rửa mặt', 'B001', 'SKU001', 10000, 'C001', 
    ...
    ('P002', N'Kem dưỡng thể', 'B002', 'SKU002', 15000, 'C002', 
    ...
    ('P003', N'Shampoo', 'B003', 'SKU003', 18000, 'C003', 
    ...
    ('P004', N'Conditioner', 'B002', 'SKU004', 19000, 'C002',
    ...
    ('P005', N'Face Cleanser', 'B004', 'SKU005', 25000, 'C004',
    ...
    ('P006', N'Sunscreen SPF 50+', 'B001', 'SKU006', 32000, 'C005',
    ...
    ('P007', N'Body Lotion', 'B003', 'SKU007', 21000, 'C006',
    ...
    ('P008', N'Anti-aging Serum', 'B005', 'SKU008', 4000, 'C007',
...
INSERT INTO ProductOrder (OrderID, ProductID, WarehouseID, Quantity) VALUES
    ('O001', 'P001', 'BW001', 2),
    ('O001', 'P002', 'BW001', 3),
    ('O001', 'P003', 'BW002', 1),
    ('O002', 'P002', 'BW001', 1),
